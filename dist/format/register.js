...
function serializeTo(doc, format, options) {
  ...
  if (!converter) _utilError.NamespaceError.raise("Target format " + format + " not defined");
...
function parseFrom(schema, value, format, options) {
  ...
  if (!converter) _utilError.NamespaceError.raise("Source format " + format + " not defined");
