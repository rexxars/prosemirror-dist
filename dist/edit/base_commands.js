...
var baseCommands = Object.create(null);

exports.baseCommands = baseCommands;
// Get an offset moving backward from a current offset inside a node.
function moveBackward(parent, offset, by) {
  if (by != "char" && by != "word") _utilError.AssertionError.raise("Unknown motion unit: " + by);
...
function listTextblockTypes(pm) {
  ...
  var found = [];
  for (var _name in pm.schema.nodes) {
    var type = pm.schema.nodes[_name];
