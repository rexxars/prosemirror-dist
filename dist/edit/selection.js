...
var SelectionError = (function (_ProseMirrorError) {
  _inherits(SelectionError, _ProseMirrorError);

  function SelectionError() {
    _classCallCheck(this, SelectionError);

    _get(Object.getPrototypeOf(SelectionError.prototype), "constructor", this).apply(this, arguments);
  }
...
function posFromDOMInner(pm, dom, domOffset, loose) {
  if (!loose && pm.operation && pm.doc != pm.operation.doc) _utilError.AssertionError.raise("Fetching a position from an outdated DOM structure");
...
function findOffsetInNode(_x4, _x5) {
  var _again2 = true;
  ...
  _function2: while (_again2) {
    ...
    if (closest.firstChild) {
      ...
      _x5 = coordsClosest;
      _again2 = true;
      closest = dyClosest = coordsClosest = offset = child = i = rects = _i = rect = dy = undefined;
      continue _function2;
    }
