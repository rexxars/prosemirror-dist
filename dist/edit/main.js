...
var ProseMirror = (function () {
  ...
  _createClass(ProseMirror, [{
    ...
    value: function setDocInner(doc) {
      if (doc.type != this.schema.nodes.doc) _utilError.AssertionError.raise("Trying to set a document with a different schema");
    ...
    value: function apply(transform) {
      ...
      if (transform.docs[0] != this.doc && (0, _model.findDiffStart)(transform.docs[0], this.doc)) _utilError.AssertionError.raise("Applying a transform that does not start with the current document");
